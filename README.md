...
Embeddings were generated for all papers in the dataset using a maximum sequence length of 512 tokens, the limit of the pre-trained model, producing 768-dimensional vectors. Evaluation was conducted using Precision@5, where relevance was defined by overlap in arXiv categories. This metric is somewhat biased because arXiv categories are broad and do not always reflect true semantic similarity. Compared with a TF-IDF baseline, the transformer-based embedding model achieved a Precision@5 of 0.7428, while TF-IDF achieved 0.7164, an improvement of 0.0264, which is somewhat marginal.
